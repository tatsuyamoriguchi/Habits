...
class UserDetailViewController: UIViewController {
    ...
    func createDataSource() -> DataSourceType {
        ...
        dataSource.supplementaryViewProvider = { (collectionView, category, indexPath) in
            let header = collectionView.dequeueReusableSupplementaryView(ofKind: "SectionHead", withReuseIdentifier: SectionHeader.reuse.identifier, for: indexPath) as! NamedSectionHeaderView
